...
correct specification with normal predictors, all recovered the
interaction coefficient and index of moderated mediation, differing
modestly in bias, root mean square error, coverage, standard errors,
Type I error, and power. Under misspecification, LSAM was most robust,
leaving some estimates unaffected by omissions that biased the
system-wide approaches, although most misspecifications degraded
performance. }
